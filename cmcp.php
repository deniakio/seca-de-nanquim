...
<head>
  ...
  <title>Coração Mole, Couro de Pedra - Seca de Nanquim</title>
    ...
    <section id="meio" class="w3-container">
      ...
      <div class="w3-center">
        ...
        <div class="w3-content" style="max-width:800px">
          <img class="mySlides" src="img/cmcp/1.jpg" style="width:100%">
          <img class="mySlides" src="img/cmcp/2.jpg" style="width:100%">
          <img class="mySlides" src="img/cmcp/3.jpg" style="width:100%">
          <img class="mySlides" src="img/cmcp/4.jpg" style="width:100%">
          <img class="mySlides" src="img/cmcp/5.jpg" style="width:100%">
        </div>
