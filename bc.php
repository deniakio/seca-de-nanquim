...
<head>
  ...
  <title>Bloqueio Criativo - Seca de Nanquim</title>
    ...
    <section id="meio" class="w3-container">
      ...
      <div class="w3-center">
        ...
        <div class="w3-content" style="max-width:800px">
          <img class="mySlides" src="img/bc/1.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/2.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/3.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/4.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/5.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/6.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/7.jpg" style="width:100%">
          <img class="mySlides" src="img/bc/8.jpg" style="width:100%">
        </div>
