...
<head>
  ...
  <title>Rock, A busca - Seca de Nanquim</title>
    ...
    <section id="meio" class="w3-container">
      ...
      <div class="w3-center">
        ...
        <div class="w3-content" style="max-width:800px">
          <img class="mySlides" src="img/rab/1.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/2.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/3.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/4.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/5.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/6.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/7.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/8.jpg" style="width:100%">
          <img class="mySlides" src="img/rab/9.jpg" style="width:100%">
        </div>
