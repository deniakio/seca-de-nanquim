...
<head>
  ...
  <title>A Coelha e o Picolé - Seca de Nanquim</title>
    ...
    <section id="meio" class="w3-container">
      ...
      <div class="w3-center">
        ...
        <div class="w3-content" style="max-width:800px">
          <img class="mySlides" src="img/cep/1.jpg" style="width:100%">
          <img class="mySlides" src="img/cep/2.jpg" style="width:100%">
          <img class="mySlides" src="img/cep/3.jpg" style="width:100%">
          <img class="mySlides" src="img/cep/4.jpg" style="width:100%">
          <img class="mySlides" src="img/cep/5.jpg" style="width:100%">
          <img class="mySlides" src="img/cep/6.jpg" style="width:100%">
        </div>
